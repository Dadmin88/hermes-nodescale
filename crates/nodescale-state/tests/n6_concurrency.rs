...
use nodescale_domain::{
    ...
    Generation, KeryxBindingAuthorizationCapability, KeryxBindingDecisionId, KeryxBindingState,
    KeryxPeerId, N6AuthenticatedBindRequest, N6BindingChallengeRequest, N6BindingRevocationIntent,
    N6BindingRotationIntent, NetworkId, OperationId, ProviderBindingId, ReasonCode,
    TrustAuthorityId,
};
use nodescale_state::{
...
fn provider_binding_id() -> ProviderBindingId {
